class SpeciesController < ApplicationController
  ...
  private
    ...
    def species_params
      params.require(:species).permit(:name, :classification, :designation, :average_height, :skin_colors, :hair_colors, :eye_colors, :average_lifespan, :homeworld, :language, :url)
    end
end
